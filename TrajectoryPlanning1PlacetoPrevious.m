function [qd1toPlacetoPrevious,vd1toPlacetoPrevious,ad1toPlacetoPrevious,VariableA1toPlacetoPrevious,steptime1toplacetoPrevious,qd1_initialplacetoPrevious,qd1_finalplacetoPrevious] = TrajectoryPlanning1PlacetoPrevious(q1p, v0, q1, vf, t0, tf)
...
steptime1toplacetoPrevious = 100*(tf-t0);
...
M = [1      t0      t0^2        t0^3;
 ...
 qd1toPlacetoPrevious = a(1).*c + a(2).*t + a(3).*t.^2 + a(4).*t.^3;
 vd1toPlacetoPrevious =  a(2).*c + 2*a(3).*t + 3*a(4).*t.^2;
 ad1toPlacetoPrevious = 2*a(3).*c + 6*a(4).*t; 
 
 qd1_initialplacetoPrevious = qd1toPlacetoPrevious(1);
 qd1_finalplacetoPrevious = qd1toPlacetoPrevious(1000);
