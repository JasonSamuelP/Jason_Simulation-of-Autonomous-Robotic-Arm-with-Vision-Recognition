function [qd2toPlace,vd2toPlace,ad2toPlace,VariableA2toPlace,steptime2toplace,qd2_initialplace,qd2_finalplace] = TrajectoryPlanning2toPlace(q2p, v0, q02, vf, t0, tf)
...
a = M\b;
 ...
 qd2toPlace = a(1).*c + a(2).*t + a(3).*t.^2 + a(4).*t.^3;
 vd2toPlace =  a(2).*c + 2*a(3).*t + 3*a(4).*t.^2;
 ad2toPlace = 2*a(3).*c + 6*a(4).*t; 
 
 qd2_initialplace = qd2toPlace(1);
 qd2_finalplace = qd2toPlace(1000);
