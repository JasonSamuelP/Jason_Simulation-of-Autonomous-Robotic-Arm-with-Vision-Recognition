function [qd3,vd3,ad3,VariableA3,steptime3,qd3_initial,qd3_final] = TrajectoryPlanning3(q03, v0, q3, vf, t0, tf)
...
a = M\b;
 ...
 qd3 = a(1).*c + a(2).*t + a(3).*t.^2 + a(4).*t.^3;
 vd3 =  a(2).*c + 2*a(3).*t + 3*a(4).*t.^2;
 ad3 = 2*a(3).*c + 6*a(4).*t; 
