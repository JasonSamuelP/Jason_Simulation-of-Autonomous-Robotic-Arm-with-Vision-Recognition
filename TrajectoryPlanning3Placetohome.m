function [qd3toPlacetohome,vd3toPlacetohome,ad3toPlacetohome,VariableA3toPlacetohome,steptime3toplacetohome,qd3_initialplacetohome,qd3_finalplacetohome] = TrajectoryPlanning3Placetohome(q3p, v0, q03, vf, t0, tf)
...
steptime3toplacetohome = 100*(tf-t0);
...
a = M\b;
 ...
 qd3toPlacetohome = a(1).*c + a(2).*t + a(3).*t.^2 + a(4).*t.^3;
 vd3toPlacetohome =  a(2).*c + 2*a(3).*t + 3*a(4).*t.^2;
 ad3toPlacetohome = 2*a(3).*c + 6*a(4).*t; 
 
 qd3_initialplacetohome = qd3toPlacetohome(1);
 qd3_finalplacetohome = qd3toPlacetohome(1000);
